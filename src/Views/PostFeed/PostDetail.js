    ...
    return (
      <View style={styles.viewContainer}>
            <View style={styles.card}>
              <View style={{flexDirection: 'row'}}>
                ...
                <View style={{ flex: 3, marginTop: 3, flexDirection: 'column'}}>
                  <Text style={{color: '#000', fontFamily: 'museo', fontWeight: 'bold'}}>{this.props.title}</Text>
                  <Text style={{fontSize: 12, marginTop: 5, marginBottom: 10}}>{this.props.description}</Text>
          ...
          <View style={{padding: 1, margin: 18, borderWidth: 1, borderColor: '#EEEEEE', backgroundColor: '#fff'}}>
            <TextInput multiline={true} numberOfLines={1} style={{backgroundColor: '#fff'}}/>
          </View>
